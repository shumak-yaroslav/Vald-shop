    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.nav_orders:
                Intent intent3 = new Intent(DashboardLayoutActivity.this,Orders.class);
            ...
            case R.id.nav_activity:
                Intent intent6 = new Intent(DashboardLayoutActivity.this,Feed.class);
                startActivity(intent6);
                break;
            case R.id.nav_logout:
                Intent intent5 = new Intent(DashboardLayoutActivity.this, EnterToAdmin.class);
