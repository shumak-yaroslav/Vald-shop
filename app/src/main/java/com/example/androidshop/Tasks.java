    ...
    public void imageClick12 () {
        img12.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(Tasks.this, DrawerLayoutActivity.class);
                        startActivity(intent);
                    }
                }
        );
        ...
        first.addValueEventListener (new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for ( DataSnapshot Subsnapshot : dataSnapshot.getChildren()) {
                    ...
                    String ShowData = adminLayouts.getTask1();
                    String ShowData1 = adminLayouts.getTask1Info();
                    String ShowData2 = adminLayouts.getTask1Status();
